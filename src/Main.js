        ...
        <div className="Main">
            <div className="esquerda">
                <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example">
                    ...
                    <Tab eventKey="voz" title="Voz">
                        <div style={{margin: 15}}>
                            <div className="description">
                                <div className="description-content">
                                    <h3>Olá, seja bem vindo!</h3>
                                    Muitas pessoas enfrentam uma enorme ansiedade social devido à gagueira e outros
                                    impedimentos de
                                    fala. Este aplicativo tem como objetivo minimizar esse risco, aprendendo quais
                                    palavras você tem
                                    dificuldade em pronunciar e, em seguida, ajudando você a gerar discursos. <br/>
                                    Vamos ler o parágrafo à direita. Quando estiver pronto, pressione o botão do
                                    microfone!
                                </div>
